...
<div class="container-fluid relative px-3">
   ...
   <div class="md:flex justify-between items-center mb-5">
                            <div>
                                <h5 class="text-lg "><a href="index.php" class="back_btn"><i class="fa-solid fa-arrow-left-long"></i></a> General User Dashboard</h5>
                            ...
                            <ul class="breadcrumb tracking-[0.5px] mb-0 inline-block mt-1">
                                    <li class="inline breadcrumb-item text-[15px] duration-500 text-slate-400 dark:text-white/60 hover:text-slate-900 dark:hover:text-white"><a href="index.php">User</a></li>
                                    <li class="inline breadcrumb-item text-[15px]  duration-500 text-slate-900 dark:text-white" aria-current="page">General User Dashboard</li>
                                </ul>
                            </div>
                        </div>
