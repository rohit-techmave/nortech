   ...
   <div class="layout-specing">
      ...
      <div class="md:flex justify-between items-center">
         ...
         <div class="action_btns d-flex">
            <a href="#" class="style_btn">Ban <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                  viewBox="0 0 24 24">
                  <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                     stroke-width="1.5" d="M6 19L19 6m0 0v12.48M19 6H6.52" /></svg></a>
            <a href="#" class="style_btn">Analysis <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                  viewBox="0 0 24 24">
                  <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                     stroke-width="1.5" d="M6 19L19 6m0 0v12.48M19 6H6.52" /></svg></a>
         </div>
               ...
               <div class="box custom-card bggredient ">
                  <div class="box-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill">
                           <p class="mb-0 fs-10 op-7 text-muted fw-semibold">TOTAL USER</p>
               ...
               <div class="box custom-card">
                  <div class="box-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill">
                           <p class="mb-0 fs-10 op-7 text-muted fw-semibold">TOTAL BALANCE</p>
                           <div class="d-flex align-items-center justify-content-between">
                              <h5 class="fw-semibold mb-0 lh-1 total_count__">$256</h5>
               ...
               <div class="box custom-card bggredient ">
                  <div class="box-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill">
                           <p class="mb-0 fs-10 op-7 text-muted fw-semibold">TOTAL NTH TOKEN</p>
                           <div class="d-flex align-items-center justify-content-between">
               ...
               <div class="box custom-card bggredient ">
                  <div class="box-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill">
                           <p class="mb-0 fs-10 op-7 text-muted fw-semibold">BUILDER</p>
                           <div class="d-flex align-items-center justify-content-between">
               ...
               <div class="box custom-card bggredient ">
                  <div class="box-body">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill">
                           <p class="mb-0 fs-10 op-7 text-muted fw-semibold">TOTAL CERTIFICATE</p>
                           <div class="d-flex align-items-center justify-content-between">
