   ...
   <div class="layout-specing">
               ...
               <ul class="finance__area finance__as_area md:w-fit w-full  flex-wrap justify-center  p-3 bg-white  shadow dark:shadow-gray-800 rounded-md usertabdash"
                  ...
                  <li role="presentation" class="md:inline-block block md:w-fit w-full">
                     <button
                        class="px-6 py-2  rounded-md w-full transition-all duration-500 ease-in-out custom-btn btn-11"
                  ...
                  <li role="presentation" class="md:inline-block block md:w-fit w-full">
                     <button class="px-6 py-2 rounded-md w-full transition-all duration-500 ease-in-out"
                        id="Courses-tab" data-tabs-target="#Courses" type="button" role="tab" aria-controls="Courses"
                        aria-selected="false">Marketplace</button>
                  </li>
                  <li role="presentation" class="md:inline-block block md:w-fit w-full">
                     <button class="px-6 py-2  rounded-md w-full transition-all duration-500 ease-in-out"
                        id="Portfolio-tab" data-tabs-target="#Portfolio" type="button" role="tab"
                        aria-controls="Portfolio" aria-selected="false">My Services</button>
                  </li>
                  <li role="presentation" class="md:inline-block block md:w-fit w-full">
                              ...
                              <div class="box-body">
                                 <div class="row">
                                    ...
                                    <div class="slider-container" id="slider1">
                                       ...
                                       <input type="range" id="percentage-slider1" class="slider_" min="0" max="100" step="1" value="0">
                           ...
                           <div class="box">
                              ...
                              <div class="box-body">
                                 <div class="row">
                                    ...
                                    <input type="range" id="percentage-slider2" class="slider_" min="0" max="100" step="1" value="0">
